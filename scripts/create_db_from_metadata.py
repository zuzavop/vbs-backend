                ...
                for id in tqdm(ids):
                    ...
                    try:
                        ...
                        metadata.append(
                            [
                                id,
                                selected_metadata['song name'],
                                selected_metadata['album name'],
                                selected_metadata['artist name'],
                                selected_metadata['utc_time'],
                                selected_metadata['local_time'],
                                selected_metadata['latitude'],
                                selected_metadata['longitude'],
                                selected_metadata['semantic_name'],
                                selected_metadata['time_zone'],
                                id.split('_')[1][:2],
                                date.weekday(),
                            ]
                        )
